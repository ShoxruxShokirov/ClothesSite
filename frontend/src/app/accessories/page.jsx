const products = [
  { name: 'Рюкзак Osprey', price: '900 000 сум', img: 'https://images.unsplash.com/photo-1517841905240-472988babdf9?auto=format&fit=crop&w=400&q=80' },
  { name: 'Термос Stanley', price: '250 000 сум', img: 'https://images.unsplash.com/photo-1512436991641-6745cdb1723f?auto=format&fit=crop&w=400&q=80' },
  { name: 'Очки Oakley', price: '500 000 сум', img: 'https://images.unsplash.com/photo-1508609349937-5ec4ae374ebf?auto=format&fit=crop&w=400&q=80' },
];
  ...
  return (
    <main style={{padding: '0 0 40px 0', background: '#f7f7f7'}}>
      ...
      <section style={{width: '100%', minHeight: 180, background: 'linear-gradient(90deg, #eaf0fa 60%, #fff 100%)', display: 'flex', alignItems: 'center', justifyContent: 'flex-start', marginBottom: 32, paddingLeft: 60}}>
        <div>
          <h1 style={{fontSize: '2.2rem', fontWeight: 800, color: '#1a5ae2', marginBottom: 10}}>Аксессуары</h1>
          <div style={{color: '#222', fontWeight: 500, fontSize: '1.1rem', maxWidth: 600}}>
            Рюкзаки, термосы, очки, перчатки и другие аксессуары для спорта и туризма.
          </div>
        </div>
      </section>
      {/* Витрина товаров */}
      ...
      <section style={{margin: '0 auto', maxWidth: 900, background: '#fff', borderRadius: 12, boxShadow: '0 2px 8px #0001', padding: 32}}>
        ...
        <div style={{fontSize: '1.05rem', color: '#222', marginBottom: 8}}><b>Address:</b> Tashkent, Mirabad district, TSUM, Islam Karimov St, 17</div>
        <div style={{fontSize: '1.05rem', color: '#222', marginBottom: 8}}><b>Phone:</b> <a href="tel:+998977603236" style={{color: '#1a5ae2', textDecoration: 'underline'}}>+998 97 760 32 36</a></div>
