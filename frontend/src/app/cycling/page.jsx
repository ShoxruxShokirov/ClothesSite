const products = [
  { name: 'Велосипед Trek Marlin 7', price: '8 500 000 сум', img: 'https://images.unsplash.com/photo-1506744038136-46273834b3fb?auto=format&fit=crop&w=400&q=80' },
  { name: 'Велошлем Giro', price: '1 200 000 сум', img: 'https://images.unsplash.com/photo-1517841905240-472988babdf9?auto=format&fit=crop&w=400&q=80' },
  { name: 'Велоперчатки Fox', price: '350 000 сум', img: 'https://images.unsplash.com/photo-1512436991641-6745cdb1723f?auto=format&fit=crop&w=400&q=80' },
];
  ...
  return (
    <main style={{padding: '0 0 40px 0', background: '#f7f7f7'}}>
      ...
      <section style={{width: '100%', minHeight: 180, background: 'linear-gradient(90deg, #eaf0fa 60%, #fff 100%)', display: 'flex', alignItems: 'center', justifyContent: 'flex-start', marginBottom: 32, paddingLeft: 60}}>
        <div>
          <h1 style={{fontSize: '2.2rem', fontWeight: 800, color: '#1a5ae2', marginBottom: 10}}>Велоспорт</h1>
          <div style={{color: '#222', fontWeight: 500, fontSize: '1.1rem', maxWidth: 600}}>
            Велосипеды, аксессуары, экипировка и всё для любителей и профессионалов.
          </div>
        </div>
      </section>
      {/* Витрина товаров */}
